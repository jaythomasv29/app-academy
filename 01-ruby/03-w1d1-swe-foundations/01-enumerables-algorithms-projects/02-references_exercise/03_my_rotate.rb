...
# positive moves left shift & push
# first element move to last
# take out the front, put it in the back
# amt.times do
#   a = array.shift!
#   array << a
# end
# take out the back, put in the front
# amt.times do
# b = array.push!
# array.unshift(b)

# negative moves right pop last & unshift into front
...
def my_rotate!(array, amt)
  amt > 0 ? amt.times { array.push(array.shift) } : (amt * -1).times { array.unshift(array.pop) } ## shifting the arra
end
